...
python 1by1.py --input_file /nfs/turbo/coe-chaijy-unreplicated/xuejunzh/output-glamm/validation/mixed_data_with_predictions.json --output_file /nfs/turbo/coe-chaijy-unreplicated/xuejunzh/output-glamm/validation/mixed_data_with_predictions_new.json --dataset_type validation
